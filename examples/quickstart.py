...
async def one_shot() -> None:
    ...
    #
    # Root's voice backend is v2: rootpy does the signalling and hands back a
    # LiveKit URL and token (session.server_url / session.access_token) rather
    # than negotiating media itself. Joining the room is yours to do, and
    # play() needs the optional [voice] extra. See the voice guide:
    # See the website's Voice section for the full flow.
