...
Root's own definition of an unread channel, which this module implements
exactly::

    last_activity_at is not None and user_last_viewed_at is not None
        and last_activity_at > user_last_viewed_at
        and channel_type is not ChannelType.VOICE
