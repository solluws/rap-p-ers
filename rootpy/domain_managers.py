...
class MemberManager:
    ...
    async def list(
        ...
        That is the trap every other list method here already avoids.
        """
...
class CommunityFileManager:
    ...
    async def edit(
        ...
        the filename.** What the server does:
        ...
        filename complete with its extension (``report.png``), and then
    ...
    async def download(self, **kwargs):
        """Root has not implemented this. Every argument shape answers
        UNIMPLEMENTED.
        ...
        Root implements the endpoint it simply starts working.
        """
