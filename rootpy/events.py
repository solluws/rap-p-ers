...
class CommunityLeaveReason(IntEnum):
    # The wire values are Unspecified=0, User=1, Kicked=4, Banned=7. There is
    # no 2 or 3 on the wire at all, which is why KICKED and BANNED are 4 and 7
    # rather than the consecutive numbering they look like they should have.
    # UNKNOWN keeps 0 deliberately: that is the server's Unspecified.
    UNKNOWN = 0
    LEFT = 1
    KICKED = 4
    BANNED = 7
