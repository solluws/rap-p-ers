...
class AccountFactory:
    ...
    email_pattern:
        Must contain ``{tag}``, e.g. ``"hello-{tag}@solluw.com"``. Keeping
    ...
    async def create(
        ...
        *,
        ...
        turnstile_token:
            ...
            challenge yourself (see ``docs/accounts.md``) and pass it here --
    ...
    async def send_verification(self, account, *,
        ...
        ``service-{tag}@solluw.com`` that's your own mail server, so how you
